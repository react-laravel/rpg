...
export default function RPGGameClient({ requireRegistration = false }: RPGGameClientProps) {
  ...
  return (
    <div
      className={`bg-muted/30 text-foreground flex flex-col [--rpg-content-inset:0.75rem] [--rpg-status-bar-block:calc(5.25rem+env(safe-area-inset-top,0px))] sm:[--rpg-content-inset:1rem] sm:[--rpg-status-bar-block:calc(5rem+env(safe-area-inset-top,0px))] ${
